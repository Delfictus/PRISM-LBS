...
impl Phase3Quantum {
    ...
    /// let phase3 = Phase3Quantum::with_gpu(Arc::new(device), "target/ptx/quantum.ptx").unwrap();
    /// ```
    pub fn with_gpu(device: Arc<CudaDevice>, ptx_path: &str) -> Result<Self, PrismError> {
