...
impl GeometryAccumulator {
    ...
    pub fn new(device: Arc<CudaDevice>, num_vertices: usize) -> Result<Self> {
        Ok(Self {
            device,
            num_vertices,
            d_hotspot_mask: None,
    ...
    pub fn set_phase0_hotspots(&mut self, hotspot_indices: &[usize]) -> Result<()> {
        ...
        self.d_hotspot_mask = Some(
            self.device
                .htod_copy(mask)
                .context("Failed to upload hotspot mask to GPU")?,
        );
    ...
    pub fn set_phase0_priorities(&mut self, priorities: &[f32]) -> Result<()> {
        ...
        self.d_reservoir_priorities = Some(
            self.device
                .htod_copy(priorities.to_vec())
                .context("Failed to upload reservoir priorities to GPU")?,
        );
        Ok(())
    }
    ...
    pub fn set_phase1_beliefs(&mut self, beliefs: &[f64], num_colors: usize) -> Result<()> {
        ...
        self.d_belief_distribution = Some(
            self.device
                .htod_copy(beliefs.to_vec())
                .context("Failed to upload beliefs to GPU")?,
        );
    ...
    pub fn set_phase1_free_energy(&mut self, free_energy: &[f64]) -> Result<()> {
        ...
        self.d_free_energy = Some(
            self.device
                .htod_copy(free_energy.to_vec())
                .context("Failed to upload free energy to GPU")?,
        );
        Ok(())
    }
    ...
    pub fn set_phase4_stress(&mut self, stress: &[f64]) -> Result<()> {
        ...
        self.d_stress_scores = Some(
            self.device
                .htod_copy(stress.to_vec())
                .context("Failed to upload stress scores to GPU")?,
        );
    ...
    pub fn set_phase4_embedding(&mut self, embedding: &[f64]) -> Result<()> {
        ...
        self.d_embedding = Some(
            self.device
                .htod_copy(embedding.to_vec())
                .context("Failed to upload embedding to GPU")?,
        );
        Ok(())
    }
    ...
    pub fn set_phase6_persistence(&mut self, persistence: &[f64]) -> Result<()> {
        ...
        self.d_persistence_scores = Some(
            self.device
                .htod_copy(persistence.to_vec())
                .context("Failed to upload persistence scores to GPU")?,
        );
    ...
    pub fn set_phase6_betti(&mut self, betti: &[i32]) -> Result<()> {
        self.d_betti_numbers = Some(
            self.device
                .htod_copy(betti.to_vec())
                .context("Failed to upload Betti numbers to GPU")?,
        );
        Ok(())
    }
